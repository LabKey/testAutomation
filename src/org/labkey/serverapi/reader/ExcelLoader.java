...
public class ExcelLoader extends DataLoader
{
    ...
    public static class Factory extends AbstractDataLoaderFactory
    {
        ...
        {
            return new ExcelLoader(file, hasColumnHeaders);
        }

        @NotNull @Override
        public DataLoader createLoader(InputStream is, boolean hasColumnHeaders)
        {
            return new ExcelLoader(is, hasColumnHeaders);
        }
    ...
    public ExcelLoader(InputStream is, boolean hasColumnHeaders)
    {
    ...
    public ExcelLoader(Workbook workbook, boolean hasColumnHeaders)
    {
        setHasColumnHeaders(hasColumnHeaders);
        _file = null;
        _workbook = workbook;
