...
/*package*/ abstract public class QueryKey<T extends QueryKey<T>> implements Comparable<T>, Serializable
{
     ...
     */
    static protected <T extends QueryKey<T>> T decode(QueryKey.Factory<T> factory, String divider, String str)
    {
        if (str == null)
            return null;
    ...
    static protected <T extends QueryKey<T>> T fromString(QueryKey.Factory<T> factory, String divider, String str)
    {
        if (str == null)
            return null;
        String[] encodedParts = StringUtils.splitPreserveAllTokens(str, divider);
    ...
    static protected <T extends QueryKey<T>> T fromString(QueryKey.Factory<T> factory, String divider, T parent, String str)
    {
    ...
    static protected <T extends QueryKey<T>> T fromParts(QueryKey.Factory<T> factory, List<String> parts)
    {
        if (parts.size() == 0)
            return null;
    ...
    static public <T extends QueryKey<T>> T fromParts(QueryKey.Factory<T> factory, T... parts)
    {
    ...
    public boolean startsWith(@NotNull org.labkey.api.query.QueryKey<? extends org.labkey.api.query.QueryKey> prefix)
    {
        if (size() < prefix.size())
            return false;
