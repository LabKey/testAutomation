...
public class VaccineDesignWebpart extends BodyWebPart<VaccineDesignWebpart.Elements>
{
    ...
    {
        getWrapper().waitForElement(elementCache().immunogensLoc.append(elementCache().tableOuterLoc));
        getWrapper().waitForElement(elementCache().adjuvantsLoc.append(elementCache().tableOuterLoc));
    }
