...
//
//
//    public static class DateFormatTestCase extends Assert
//    {
//        int gmtHour(long ms)
//        {
...
//        {
//            // given the above, we expect hours field to change based on date for EET, CET, WET
//            assertEquals(20, gmtHour(calendarNoon("America/Los_Angeles", Calendar.JANUARY)));       // winter
//            assertEquals(19, gmtHour(calendarNoon("America/Los_Angeles", Calendar.JULY)));          // summer
//
//            assertEquals(10, gmtHour(calendarNoon("EET", Calendar.JANUARY)));                       // winter
//            assertEquals( 9, gmtHour(calendarNoon("EET", Calendar.JULY)));                          // summer
//
//            assertEquals(11, gmtHour(calendarNoon("CET", Calendar.JANUARY)));                       // winter
//            assertEquals(10, gmtHour(calendarNoon("CET", Calendar.JULY)));                          // summer
//
//            assertEquals(12, gmtHour(calendarNoon("WET", Calendar.JANUARY)));                       // winter
//            assertEquals(11, gmtHour(calendarNoon("WET", Calendar.JULY)));                          // summer
//
//            // If we use FastDateFormat the times _do_not_change_ as we export (or at least hope)
//            var fastFormat = FastDateFormat.getInstance("yyyy-MM-dd HH:mm (zzz)");
//
//            assertEquals(20, gmtHour(fastFormat.parse("2020-01-01 12:00 (Pacific Time)").getTime()));  // winter
//            assertEquals(20, gmtHour(fastFormat.parse("2020-07-01 12:00 (Pacific Time)").getTime()));  // summer
//
//            assertEquals(10, gmtHour(fastFormat.parse("2020-01-01 12:00 (EET)").getTime()));        // winter
//            assertEquals(10, gmtHour(fastFormat.parse("2020-07-01 12:00 (EET)").getTime()));        // summer
//
//            assertEquals(11, gmtHour(fastFormat.parse("2020-01-01 12:00 (CET)").getTime()));        // winter
//            assertEquals(11, gmtHour(fastFormat.parse("2020-07-01 12:00 (CET)").getTime()));        // summer
//
//            assertEquals(12, gmtHour(fastFormat.parse("2020-01-01 12:00 (WET)").getTime()));        // winter
//            assertEquals(12, gmtHour(fastFormat.parse("2020-07-01 12:00 (WET)").getTime()));        // summer
//        }
//    }
}
