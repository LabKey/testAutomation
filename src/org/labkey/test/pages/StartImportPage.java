...
public class StartImportPage extends LabKeyPage
{
    ...
    public enum AdvancedOptionsCheckBoxes
    {
        ...
        AssayDatasetData("Datasets: Assay Dataset Data"),
        AssayDatasetDefinition("Datasets: Assay Dataset Definitions"),
        SampleTypeDatasetData("Datasets: Sample Dataset Data"),
        SampleTypeDatasetDefinition("Datasets: Sample Dataset Definitions"),
        StudyDatasetData("Datasets: Study Dataset Data"),
        StudyDatasetDefinition("Datasets: Study Dataset Definitions"),
