...
/**
 * MS2Tests_20070101__2_9_9 class
* <p/>
* Created: Aug 15, 2007
*
* @author bmaclean
*/
public class MS2Tests_20070101__2_9_9 extends MS2TestsBase
{
    public MS2Tests_20070101__2_9_9(BaseSeleniumWebTest test)
    {
        super(test);
    }
    ...
    public void addTestsScoringOrganisms()
    {
        ...
        listParams.add(new MS2ScoringParams(test, "yeast/Paulovich_101705_ltq", "xt_yeastp",
                new String[] { "YAL003W", "YAL005C", "YAL012W", "YAL023C", "YAL035W", "YAL038W", "YAR002C-A",
                                ...
                                "YBL041W", "YBL072C", /* "YBL075C", 2005.12.01 */ "YBL076C", "YBL087C", "YBL092W", "YBL099W",
                                ...
                                "YMR246W", "YMR290C", /* "YMR303C", 2005.12.01 */ "YMR307W", "YMR308C", "YMR309C", "YMR318C",
                                ...
                                "YBR263W", "YGL078C", "YKL029C", "YLR270W", "YLR291C", "YLR447C", },
//                0.9973, 157, 1.0, 61));   X! Tandem 2005.12.01
        ...
        listParams.add(new MS2ScoringParams(test, "yeast/Paulovich_101705_ltq", "xc_yeastp",
                new String[] { "YAL003W", "YAL005C", "YAL012W", "YAL023C", "YAL035W", "YAL038W", "YAR002C-A",
                                ...
                                "YOL103W-B" },
//                0.9973, 337, 0.98, 148));     X! Tandem 2005.12.01
                0.9973, 336, 0.98, 148));
...
//                  0.9973, 336, 0.98, 148));     X! Comet
        ...
        listParams.add(new MS2ScoringParams(test, "yeast/comp12vs12standSCX", "xt_yeast",
                new String[] { "YAL003W", "YAL005C", "YAL012W", "YAL016W", "YAL023C", "YAL035W", "YAL038W",
                                ...
                                "YIL041W", "YIL043C", "YIL051C", "YIL053W", "YIL074C", /* "YIL076W", 2005.12.01 */ "YIL078W",
                                ...
                                // X! Tandem 2007.01.01.1
                                "YBR177C", "YDR168W", "YLR248W", "YOR051C", "YPL019C", "YMR050C", "YPR137C-B" },
...
//                0.9967, 50, 1.0, 33));    X! Tandem 2005.12.01
                0.9967, 50, 1.0, 23));
...
//                0.9977, 36, 0.96, 7));  X! Tandem 2005.12.01
                0.9977, 31, 0.9, 7));
        listParams.add(new MS2ScoringParams(test, "mix/Keller_omics", "xc_komics",
                new String[] { "ACTA_BOVIN", "ALBU_BOVIN", "AMY_BACLI", "BGAL_ECOLI", "CAH2_BOVIN", "CASB_BOVIN",
                                "CATA_BOVIN", "CYC_BOVIN", "G3P_RABIT", "LACB_BOVIN", "LALBA_BOVIN", "PHS2_RABIT",
                                "PPB_ECOLI", "TRFE_BOVIN" },
//                0.9901, 106, 0.99, 33));  X! Tandem 2005.12.01
                0.9909, 108, 0.99, 34));
...
//        qp.addRatio("UPSP:ALBU_BOVIN", new MS2QuantRatio(3.76, 0.81));    X! Tandem 2005.12.01
        qp.addRatio("UPSP:ALBU_BOVIN", new MS2QuantRatio(3.77, 0.81));
        qp.addRatio("UPTR:O97941_BOVIN", new MS2QuantRatio(3.24, 0.41));
        qp.addRatio("UPSP:CO4_BOVIN", new MS2QuantRatio(2.81, 0.01));
//        qp.addRatio("UPTR:Q3SZR2_BOVIN", new MS2QuantRatio(3.88, 0.99)); X! Tandem 2005.12.01
        qp.addRatio("UPTR:Q3SZR2_BOVIN", new MS2QuantRatio(3.88, 0.98));
        listParams.add(qp);
...
//        qp.addRatio("UPSP:ALBU_BOVIN", new MS2QuantRatio(2.3, 1.78)); X! Tandem 2005.12.01
        qp.addRatio("UPSP:ALBU_BOVIN", new MS2QuantRatio(2.18, 1.66));
