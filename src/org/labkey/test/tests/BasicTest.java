...
public class BasicTest extends BaseSeleniumWebTest
{
    ...
    protected void doTestSteps()
    {
        ...
        final Locator searchLocator = Locator.raw("//th[./spancontains(text(), 'Search')]]/..//a/img[@title='Remove From Page']");
