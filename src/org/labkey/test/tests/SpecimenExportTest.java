...
public class SpecimenExportTest extends SpecimenBaseTest
{
    ...
    private void verifySpecimenSettingsInArchive()
    {
        ...
        assertTrue("study.xml did not include expected <specimens> element: " + studyXmlText, studyXmlText.contains("<specimens dir=\"specimens\" settings=\"specimen_settings.xml\" file=\"Study.specimens\"/>"));
