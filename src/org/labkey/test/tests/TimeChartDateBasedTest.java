...
public class TimeChartDateBasedTest extends TimeChartTest
{
    ...
    private static final String SVG_PARTICIPANTGROUP_SOME = "Created with Rapha\u00ebl 2.1.0New Chart Title: Some ParticipantsDays Since Start Date050100150200250300350CD4+ (cells/mm3), Lymphs (cells/mm3)200.0400.0600.0800.01000.01200.01400.01600.01800.02000.02200.0 249318596 Lymphs(cells/mm3) 249320107 Lymphs(cells/mm3) 249318596 CD4+(cells/mm3) 249320107 CD4+(cells/mm3)";
    private static final String SVG_PARTICIPANTGROUP_SOME_MODIFIED = "Created with Rapha\u00ebl 2.1.0New Chart Title: Some ParticipantsDays Since Start Date50100150200250300350CD4+ (cells/mm3), Lymphs (cells/mm3)200.0400.0600.0800.01000.01200.01400.01600.01800.0 249318596 Lymphs(cells/mm3) 249318596 CD4+(cells/mm3)";
    private static final String SVG_PARTICIPANTGROUP_OTHER = "Created with Rapha\u00ebl 2.1.0New Chart Title: Other ParticipantsDays Since Start Date050100150200250300350CD4+ (cells/mm3), Lymphs (cells/mm3)200.0400.0600.0800.01000.01200.01400.01600.01800.02000.02200.0 249320127 Lymphs(cells/mm3) 249320489 Lymphs(cells/mm3) 249320127 CD4+(cells/mm3) 249320489 CD4+(cells/mm3)";
    private static final String SVG_PARTICIPANTGROUP_YET_MORE = "Created with Rapha\u00ebl 2.1.0New Chart Title: Yet More ParticipantsDays Since Start Date050100150200250300350CD4+ (cells/mm3), Lymphs (cells/mm3)200.0400.0600.0800.01000.01200.01400.01600.01800.02000.02200.0 249320489 Lymphs(cells/mm3) 249320897 Lymphs(cells/mm3) 249325717 Lymphs(cells/mm3) 249320489 CD4+(cells/mm3) 249320897 CD4+(cells/mm3) 249325717 CD4+(cells/mm3)";
    private static final String SVG_PARTICIPANTGROUP_1 = "Created with Rapha\u00ebl 2.1.0New Chart Title: Group 1: Accute HIV-1Days Since Start Date050100150200250300350CD4+ (cells/mm3), Lymphs (cells/mm3)200.0400.0600.0800.01000.01200.01400.01600.01800.02000.02200.0 249318596 Lymphs(cells/mm3) 249320107 Lymphs(cells/mm3) 249320489 Lymphs(cells/mm3) 249318596 CD4+(cells/mm3) 249320107 CD4+(cells/mm3) 249320489 CD4+(cells/mm3)";
    private static final String SVG_PARTICIPANTGROUP_2 = "Created with Rapha\u00ebl 2.1.0New Chart Title: Group 2: HIV-1 NegativeDays Since Start Date050100150200250300350CD4+ (cells/mm3), Lymphs (cells/mm3)200.0400.0600.0800.01000.01200.01400.01600.01800.02000.02200.0 249320127 Lymphs(cells/mm3) 249320897 Lymphs(cells/mm3) 249325717 Lymphs(cells/mm3) 249320127 CD4+(cells/mm3) 249320897 CD4+(cells/mm3) 249325717 CD4+(cells/mm3)";
...
//        sleep(1000); // attempt fix for intermittent failure issue where applyChanges button is clicked too quickly (selected measure properties need to be initialized)
        ...
        waitForElement(Locator.css("svg").withText(SVG_MULTI_MANUAL_1), WAIT_FOR_JAVASCRIPT, false);
        Assert.assertEquals("Second SVG was not as expected", SVG_MULTI_MANUAL_1, getText(Locator.css("svg")));

        goToAxisTab("Hemogoblins");
        setAxisValue(Axis.RIGHT, "rightaxis_range_automatic", null, null, null, "rightaxis_scale", "Log", null, null);
        waitForElement(Locator.css("svg").withText(SVG_MULTI_MANUAL_2), WAIT_FOR_JAVASCRIPT, false);
        Assert.assertEquals("Second SVG was not as expected", SVG_MULTI_MANUAL_2, getText(Locator.css("svg")));
