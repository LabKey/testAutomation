...
public class JUnitBVTTest
{
    static boolean accept(Map<String, Object> test)
    {
        return "DRT".equals(JUnitTest.getWhen(test)) || "BVT".equals(JUnitTest.getWhen(test));
    }

    public static TestSuite suite() throws Exception
    {
        return JUnitTest._suite(JUnitBVTTest::accept, 0, false);
    }
}
