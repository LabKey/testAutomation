...
public class UserPermissionsTest extends BaseSeleniumWebTest
{
    ...
    protected void doCleanup()
    {
        ...
        //Make sure we delete sub foders first
        deleteFolder(PERM_PROJECT_NAME, GAMMA_SUB_FOLDER_NAME);
    ...
    private void userPermissionRightsTest(){
        ...
        impersonateUser(GAMMA_EDITOR_USER);
        clickLinkWithText(PERM_PROJECT_NAME);
        ...
        impersonateUser(GAMMA_READER_USER);
        clickLinkWithText(PERM_PROJECT_NAME);
        clickLinkWithText(GAMMA_SUB_FOLDER_NAME);
    ...
    /**
     * Consider moving this to BaseWebTest?
     *
