...
public class TestDataGenerator
{
    ...
    private final List<Map<String, Object>> _insertedRows = new ArrayList<>();
    ...
    /**
     * Get all rows previously inserted by this instance
     */
    public List<Map<String, Object>> getInsertedRows()
    {
    ...
    {
        SaveRowsResponse response = getQueryHelper(cn).insertRows(rows);
        _insertedRows.addAll(rows);
        return response;
    }
