...
import org.labkey.test.pages.ReactAssayTypeSelectPage;
...
public abstract class AbstractAssayHelper
{
    ...
    public ReactAssayDesignerPage createAssayDesign(String type, String name)
    {
        ...
        ReactAssayDesignerPage assayDesigner = new ReactAssayTypeSelectPage<>(_test.getDriver()).selectAssayType(type);
