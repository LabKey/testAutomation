...
public class Ext4HelperWD extends AbstractHelperWD
{
    ...
    public static class Locators
    {
        ...
        {
            return Locator.xpath("(//table|//tbody)").withClass("x4-form-item").withPredicate("(tbody/tr|tr)/(td|td/div)/label[normalize-space()='" + label + "']").notHidden();
        }

        public static Locator.XPathLocator formItemWithLabelContaining(String label)
        {
            return Locator.xpath("(//table|//tbody)").withClass("x4-form-item").withPredicate("(tbody/tr|tr)/(td|td/div)/label[contains(normalize-space(), '" + label + "')]").notHidden();
        }
