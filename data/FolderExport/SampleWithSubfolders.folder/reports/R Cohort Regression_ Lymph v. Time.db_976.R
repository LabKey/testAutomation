...
plot(x1, y1, xlab="Months", xaxt="n", ylab="Lymphocytes (cells/mm3)", main="Lymphocytes By Cohort Over Time", 
xlim=range(labkey.data$date), ylim=range(labkey.data$lymphocytes), pch=15, col="red") 

# For an x axis measured in years, use the following call to plot instead and cut the later call to axis(). 
# plot(x1, y1, xlab="Time", ylab="Lymphocytes (cells/mm3)", main="Lymphocytes By Cohort Over Time", xlim=range(labkey.data$date), ylim=range(labkey.data$lymphocytes), pch=15, col="red") 
