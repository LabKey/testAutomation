...
run.error.level = 0; 
run.props = labkey.transform.readRunPropertiesFile("C:/Development/labkey/release20.3-SNAPSHOT/server/testAutomation/data/qc/TransformAndValidationFiles/AssayId_1/work-1/runProperties.tsv");
