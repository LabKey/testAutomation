...
package org.labkey.test.components.starterartifacts;
 ...
 */
public class StarterArtifactsWebPart extends BodyWebPart<StarterArtifactsWebPart.ElementCache>
{
    public StarterArtifactsWebPart(WebDriver driver)
    {
        this(driver, 0);
    }

    public StarterArtifactsWebPart(WebDriver driver, int index)
    {
        super(driver, "StarterArtifacts", index);
    }

    public StarterArtifactsWebPart setInput(String value)
    {
